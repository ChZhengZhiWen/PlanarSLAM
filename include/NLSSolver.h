#ifndef Planar_SLAM_NLSSOLVER_H_
#define Planar_SLAM_NLSSOLVER_H_
...
namespace Planar_SLAM {
    ...
    public:
        ...
        void optimize(ModelType &model,float &_chi2);

        /// Gauss Newton optimization strategy
        void optimizeGaussNewton(ModelType &model,float &_chi2);
